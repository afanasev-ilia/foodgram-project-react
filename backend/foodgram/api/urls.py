...
from api.views import UsersViewSet, AuthToken  # , LogoutToken
...
urlpatterns = [
    ...
    path('v1/auth/token/login/', AuthToken.as_view(), name='token'),
    # path('v1/auth/token/logout/', LogoutToken.as_view(), name='logoutoken'),
]
